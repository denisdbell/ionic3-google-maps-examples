...
export const MAPMARKERS: MapMarker[] = [
    ...
    {  
        label: "promotion",
        icon: "promotion.png",
        description: "<h1>Free T-Shirts</h1>",
        category: "promotion",
    ...
    {  
        label: "higlight",
        icon: "highlight.png",
        description: "<h1>Stone Love Vs Mighty Crown</h1>",
        category: "highlight",
